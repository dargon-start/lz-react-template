        ...
        <MotionContainer className='flex flex-col items-center justify-center px-2'>
          ...
          <motion.div variants={varBounce().in}>
            ...
            >
              ...
              />
              {/* 0 */}
              <path d='M244.9 182.5c82.3 1.4 82.2 123.8 0 125.2-82.3-1.5-82.3-123.8 0-125.2zm0 23.1c-51.8.9-51.8 77.9 0 78.8 51.8-.9 51.7-77.9 0-78.8z' />
              {/* 4_4 */}
              <path
          ...
          <NavLink to={HOMEPAGE} className='rounded-md p-4'>
            Go to Home
          </NavLink>
        </MotionContainer>
      </div>
